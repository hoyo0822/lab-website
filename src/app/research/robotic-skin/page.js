...
export const metadata = { title: "Robotic Skin – BIRD Lab @ KIST" };

const topics = [
  {
    title: "Skin Computer",
    image: "/research/robotic-skin-1.png",
    imageLeft: true,
    bullets: [
  ...
  {
    title: "Large-area Tactile Robotic Skin",
    image: "/research/robotic-skin-2.png",
    imageLeft: false,
    bullets: [
...
export default function RoboticSkinPage() {
  return (
    <div style={{ maxWidth: "960px", margin: "0 auto", padding: "3rem 2rem" }}>
      ...
      <h1 style={{ fontSize: "2rem", fontWeight: 800, marginBottom: "0.4rem", color: "var(--text)" }}>Robotic Skin</h1>
