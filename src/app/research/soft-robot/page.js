...
export const metadata = {
  title: "Soft Robots – BIRD Lab @ KIST",
};
  ...
  return (
    <div style={{ maxWidth: "1100px", margin: "0 auto", padding: "3rem 2rem" }}>
      ...
      <div className="img-grid-2">
        {["/research/soft-robot-1.png", "/research/soft-robot-2.png"].map((src, i) => (
          <div key={i} style={{
            ...
            <Image src={src} alt={`Soft robot ${i + 1}`} fill sizes="(max-width: 600px) 100vw, 50vw" style={{ objectFit: "cover" }} />
          </div>
        ))}
      </div>
